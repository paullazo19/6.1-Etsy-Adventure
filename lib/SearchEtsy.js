function SearchEtsy(){
  ...
  searchEtsy.buildURL = function($input){
    return "https://openapi.etsy.com/v2/listings/active.js?api_key=h9oq2yf3twf4ziejn10b717i&keywords=" + $input + "&includes=Images&callback=?";
  }
  searchEtsy.useKeyword = function(){

    $("[data-js='input']").on("keyup", function(e){
      $input = e.target.value;
      var $url = searchEtsy.buildURL();
